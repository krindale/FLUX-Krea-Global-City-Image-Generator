...
class RegionalBatchGenerator:
    ...
    def create_flux_krea_workflow(self, positive_prompt: str, negative_prompt: str, filename: str, seed: int = None) -> Dict:
        """FLUX Krea 모델용 워크플로우 생성 (LoRA 포함)"""
        if seed is None:
